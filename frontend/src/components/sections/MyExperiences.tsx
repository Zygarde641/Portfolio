    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative">
          {/* Timeline line */}
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-red-500 via-red-500/50 to-transparent transform md:-translate-x-1/2" />
          ...
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-red-500 rounded-full transform -translate-x-1/2 border-4 border-black z-10">
                <motion.div
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            ...
            >
              ...
              <span className="text-white group-hover:text-red-400 transition-colors">GitHub</span>
            </a>
            ...
            >
              ...
              <span className="text-white group-hover:text-red-400 transition-colors">LinkedIn</span>
            </a>
            ...
            >
              ...
              <span className="text-white group-hover:text-red-400 transition-colors">zarjun641@gmail.com</span>
            </a>
...
>
  ...
  />
              ...
              <span className="text-white group-hover:text-red-400 transition-colors">+91 91255 45599</span>
            </a>
          </div>
